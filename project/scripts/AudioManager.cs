...
public class AudioManager : MonoBehaviour
{
    ...
    {
        AudioMusic.PlayOneShot(musicClips[musicType]);
    }

    public void PlayMusic(int musicTypeInt)
    {
        AudioMusic.PlayOneShot(musicClips[(MusicType)musicTypeInt]);
    }

    public void PlayMusic(string musicTypeName)
    {
        AudioMusic.PlayOneShot(musicClips[(MusicType)System.Enum.Parse(typeof(MusicType), musicTypeName)]);
    }
}
